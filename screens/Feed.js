...
const Feed = ({route}) => {
  ...
  return (
    ...
    {/* <ScrollView> */}
      ...
      <ItemInFeed key={3} userID={2} isVerified={0} Name={"Madison"} Age={"21"} Comp={"85"} Bio={"Hey, I'm a laid-back soul who finds joy in the simple pleasures of life. From cozy movie nights to impromptu picnics in the park, I believe in making every moment count. If you're someone who enjoys laughter, good conversation, and a carefree vibe, we might just hit it off!"} AppReason={1} Interests={["Sports", "Food", "Cooking"]} Music={["Rock"]} Job={"Job"}/>
