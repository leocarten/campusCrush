    ...
    <SafeAreaView>
      ...
      {/* <HorizontalIconLine count={5}  /> */}
        ...
        <View style={{marginBottom: '40%'}}>
            ...
            <Text style={{textAlign: 'center', fontSize: 22, fontWeight: '400', color: '#333', marginLeft: '3%', marginRight: '3%'}}>{spin['message']}</Text>
            <Text style={{textAlign: 'center', fontSize: 22, fontWeight: '400', color: '#333', marginTop: '3%'}}>Your new balance is {spin['newBalance']} tokens.</Text>
